...
public class SimpleRobot {
    ...
    /** count of the number of robots created */
    ...
    /** flag to say if this robot is visible */
    ...
    /**
     * Constructor that takes the x and y position for the robot
     * @param x the x pos
     * @param y the y pos
     */
     ...
     */
    public SimpleRobot(int x, int y, ModelDisplay display) {
     ...
     */
    public SimpleRobot(int x, int y, Picture picture) {
        this(x, y); // invoke constructor that takes x and y
    ...
    /**
      * Get the distance from this robot to another.
      *
      * @param robot The robot to compute the distance betwen.
      */
    public double getDistance(SimpleRobot robot) {
        return getDistance(robot.xPos, robot.yPos);
    }
    ...
    /**
     * Method to turn to face another simple robot
     * @param robot the robot turn towards
     */
    public void turnToFace(SimpleRobot robot) {
        turnToFace(robot.xPos, robot.yPos);
    }
    ...
    */
    public void turnToFace(int x, int y) {
        ...
        // avoid a divide by 0
        if (dx == 0) {
            // if below the current robot
            if (dy > 0) {
                heading = 180;
            }

            // if above the current robot
            else if (dy < 0) {
                heading = 0;
            }
        }
    ...
    /**
     * Method to get the picture for this simple robot
     * @return the picture for this robot (may be null)
     */
    ...
    /**
     * Method to set the picture for this simple robot
    ...
    /**
     * Method to get the model display for this simple robot
    ...
    /**
     * Method to set the model display for this simple robot
    ...
    /**
     * Method to show the robot information string
    ...
    /**
     * Method to set the color of the robot.
    ...
    /**
     * Method to get the name of the robot
    ...
    /**
     * Method to set the name of the robot
    ...
    /**
     * Method to hide the robot (stop showing it)
    ...
    /**
     * Method to show the robot (doesn't affect
     * the pen status
     */
    public void show() {
    ...
    public void setVisible(boolean value) {
        // if the robot wasn't visible and now is
    ...
    /**
     * Method to update the display of this robot and
     * also check that the robot is in the bounds
     */
    ...
    /**
     * Method to move the robot foward 100 pixels
     */
    public void forward() {
        forward(100);
    }
    ...
    /**
     * Method to move the robot forward the given number of pixels
    ...
    /**
     * Method to move to robot to the given x and y location
    ...
    /**
     * Method to turn the robot the passed degrees
    ...
    /**
     * Method to draw a passed picture at the current robot
    ...
    public synchronized void drop(Picture dropPicture) {
        ...
        if (g2 != null) {
            ...
            // rotate to robot heading and translate to xPos and yPos
    ...
    public synchronized void paintComponent(Graphics g) {
        ...
        if (visible) {
            ...
            // rotate the robot and translate to xPos and yPos
            g2.rotate(Math.toRadians(heading), xPos, yPos);
            ...
            g2.fillOval(xPos-halfWidth-3, yPos-halfHeight-8, 6, 16);
            g2.fillOval(xPos+halfWidth-2, yPos-halfHeight-8, 6, 16);
...
//    	}
     ...
     * about this robot
     * @return a string with information about this robot
     */
